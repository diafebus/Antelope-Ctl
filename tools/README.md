...
| Check browser rendering and link interaction | `node tools/test_webui_meters.cjs`, `node tools/test_webui_mixer_links.cjs`, and `node tools/test_webui_input_links.cjs` | No |
